...
const spaces = [
  ["01", "POOL & WATER", "탁 트인 풍경 속에서 즐기는 물과 휴식"],
  ["02", "TENT", "하루의 속도를 낮추는 프라이빗한 자리"],
  ["03", "BBQ & GRILL", "함께 차리고 나누는 자연 속의 식사"],
  ["04", "CAFE", "머무는 시간 사이에 만나는 여유"],
  ["05", "PARTY & RENTAL", "모임과 촬영을 위한 특별한 공간"],
];
