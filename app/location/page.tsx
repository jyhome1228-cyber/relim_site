...
export default function Location() {
  return <PageShell><main>
    ...
    <section className="location-info"><div><small>ADDRESS</small><h2>경기도 용인시 처인구 원삼면</h2><p>보개원삼로1372번길 41</p></div><div className="location-actions"><a className="button primary" href={mapUrl} target="_blank" rel="noreferrer">네이버 지도 열기</a><a className="button text" href="tel:010-5794-8823">길찾기 문의</a></div></section>
